...
//=========  (Mon Nov 23 12:45:09 2015) by ROOT version6.02/05
   TCanvas *hmt = new TCanvas("hmt", "hmt",220,242,700,700);
   hmt->Range(-25,-6.724317,225,0.233789);
   hmt->SetFillColor(0);
   hmt->SetBorderMode(0);
   hmt->SetBorderSize(2);
   hmt->SetLogy();
   ...
   hmt_stack_12->SetMinimum(9.364696e-07);
   hmt_stack_12->SetMaximum(0.3451266);
   ...
   hmt56->SetBinContent(1,0.05452696);
   hmt56->SetBinContent(2,0.06844174);
   hmt56->SetBinContent(3,0.00899946);
   hmt56->SetBinError(1,0.01883648);
   hmt56->SetBinError(2,0.02216672);
   hmt56->SetBinError(3,0.008346573);
   hmt56->SetEntries(48);
   ...
   hmt57->SetBinContent(1,0.1770178);
   hmt57->SetBinContent(2,0.1521364);
   hmt57->SetBinContent(3,0.1500861);
   hmt57->SetBinContent(4,0.1173096);
   hmt57->SetBinContent(5,0.003795927);
   hmt57->SetBinContent(6,8.681582e-05);
   hmt57->SetBinContent(7,2.866842e-05);
   hmt57->SetBinError(1,0.004852291);
   hmt57->SetBinError(2,0.004963724);
   hmt57->SetBinError(3,0.004982872);
   hmt57->SetBinError(4,0.004830345);
   hmt57->SetBinError(5,0.001425256);
   hmt57->SetBinError(6,3.545477e-05);
   hmt57->SetBinError(7,2.027973e-05);
   hmt57->SetEntries(12325);
   ...
   hmt58->SetBinContent(1,0.07307961);
   hmt58->SetBinContent(2,0.06336982);
   hmt58->SetBinContent(3,0.007199152);
   hmt58->SetBinContent(4,0.002226667);
   hmt58->SetBinContent(5,0.0005420272);
   ...
   hmt58->SetBinError(1,0.001384586);
   hmt58->SetBinError(2,0.001218745);
   hmt58->SetBinError(3,0.0004060783);
   hmt58->SetBinError(4,0.0002266372);
   hmt58->SetBinError(5,0.0001002692);
   ...
   hmt59->SetBinContent(1,0.00600016);
   hmt59->SetBinContent(2,0.005383177);
   hmt59->SetBinContent(3,0.002961519);
   hmt59->SetBinContent(4,0.001203117);
   hmt59->SetBinContent(5,0.0003547652);
   hmt59->SetBinContent(6,3.084915e-05);
   hmt59->SetBinError(1,0.0003042202);
   hmt59->SetBinError(2,0.0002881549);
   hmt59->SetBinError(3,0.0002137292);
   hmt59->SetBinError(4,0.0001362262);
   hmt59->SetBinError(5,7.397367e-05);
   hmt59->SetBinError(6,2.181364e-05);
   hmt59->SetEntries(1033);
   ...
   hmt60->SetBinContent(2,1.677165e-05);
   hmt60->SetBinError(2,1.677165e-05);
   hmt60->SetEntries(1);
